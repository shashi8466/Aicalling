...
const TABLE = 'meeting_ai_analysis';
...
const MeetingAnalysis = {
  ...
  async findOne(filter = {}) {
    const rows = await MeetingAnalysis.find(filter, { limit: 1 });
    return rows[0] || null;
  },
  ...
  async create(data) {
    ...
    const row = { summary: '', action_items: [], sentiment_timeline: [], intelligence: {}, created_at: now, updated_at: now };
...
module.exports = MeetingAnalysis;
