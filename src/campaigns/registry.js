...
const CAMPAIGNS = {
  ...
  'sat-batch': {
    ...
    program: 'SAT',
    // Spoken right after the caller confirms their identity.
    // Note: "Hello, this is Shashi from Aiprep365" is already said by the webhook opener.
    turn0Line: (lead) =>
      `We are excited to let you know that we've launched a new SAT Preparation Batch group ` +
      `for students planning to take the SAT. ` +
      `Our program includes a personalized SAT study plan, live expert classes, full-length SAT practice tests, ` +
      `one-on-one counseling, college admissions guidance, and regular progress tracking. ` +
      `Would you like to learn more about our SAT Preparation Program?`,
    systemContext: (lead) =>
`━━━ CAMPAIGN: SAT BATCH PROMOTION ━━━
This is an OUTREACH call inviting ${firstName(lead)} to join Aiprep365's newly launched SAT Preparation Batch.
The student may NOT have interacted with Aiprep365 before — never assume prior contact or a demo test.

OPENING INTENT (already delivered): Announced the new SAT Batch and asked if they'd like to learn more.

If they say YES or show any interest:
Say: "Wonderful! I'd be happy to schedule a FREE 10–15 minute consultation with one of our SAT advisors so they can explain the program and answer all your questions." then [OFFER_MEETING]

After the meeting is booked, say EXACTLY:
"Thank you! Your consultation has been successfully scheduled. You'll receive the meeting details by email shortly. We look forward to helping you prepare for the SAT. Have a wonderful day!" then [END_CALL]

Highlight naturally (never as a list, one idea per turn):
personalized SAT study plan, live expert classes, full-length SAT practice tests,
one-on-one counseling, college admissions guidance, and regular progress tracking.

GOAL: book a FREE 10–15 minute consultation with an SAT advisor.
Frame EVERY meeting offer as an SAT advisor consultation.`,
  },
  ...
  'act-batch': {
    ...
    program: 'ACT',
    turn0Line: (lead) =>
      `We've recently opened enrollment for our new ACT Preparation Batch. ` +
      `Our program includes a personalized ACT study plan, live expert classes, ACT practice exams, ` +
      `one-on-one mentoring, college admissions guidance, and weekly progress tracking. ` +
      `Would you like to learn more about our ACT Preparation Program?`,
    systemContext: (lead) =>
`━━━ CAMPAIGN: ACT BATCH PROMOTION ━━━
This is an OUTREACH call inviting ${firstName(lead)} to join Aiprep365's new ACT Preparation Batch.
The student may NOT have interacted with Aiprep365 before — never assume prior contact or a demo test.

OPENING INTENT (already delivered): Announced the new ACT Batch and asked if they'd like to learn more.

If they say YES or show any interest:
Say: "Great! I'd be happy to schedule a FREE 10–15 minute consultation with one of our ACT advisors." then [OFFER_MEETING]

After the meeting is booked, say EXACTLY:
"Thank you! Your consultation has been scheduled successfully. You'll receive a confirmation email shortly. Have a great day!" then [END_CALL]

Highlight naturally (never as a list, one idea per turn):
personalized ACT study plan, live expert classes, ACT practice exams,
one-on-one mentoring, college admissions guidance, and weekly progress tracking.

GOAL: book a FREE 10–15 minute consultation with an ACT advisor.
Frame EVERY meeting offer as an ACT advisor consultation.`,
  },
  ...
  'ap-course': {
    ...
    program: 'AP',
    turn0Line: (lead) =>
      `We're excited to announce new AP preparation courses for students planning to take Advanced Placement exams. ` +
      `Our program includes AP subject preparation, live expert instructors, practice tests and assignments, ` +
      `personalized study plans, one-on-one academic counseling, and progress monitoring. ` +
      `Would you like to learn more about our AP courses?`,
    systemContext: (lead) =>
`━━━ CAMPAIGN: AP COURSE PROMOTION ━━━
This is an OUTREACH call inviting ${firstName(lead)} to Aiprep365's new AP preparation courses.
The student may NOT have interacted with Aiprep365 before — never assume prior contact or a demo test.

OPENING INTENT (already delivered): Announced the new AP courses and asked if they'd like to learn more.

If they say YES or show any interest:
Say: "Wonderful! Let me schedule a FREE 10–15 minute consultation with one of our AP advisors." then [OFFER_MEETING]

After the meeting is booked, say EXACTLY:
"Thank you! Your consultation has been booked successfully. We look forward to speaking with you." then [END_CALL]

Highlight naturally (never as a list, one idea per turn):
AP subject preparation, live expert instructors, practice tests and assignments,
personalized study plans, one-on-one academic counseling, and progress monitoring.

GOAL: book a FREE 10–15 minute consultation with an AP advisor.
Frame EVERY meeting offer as an AP advisor consultation.`,
  },
