...
router.post('/call/start', async (req, res) => {
  ...
  try {
    ...
    if (campaign.opener) {
      ...
      opener = isFollowUp
        ? `Hi, this is Annie, from Test Prep Pundits. May I please speak with ${studentFirst} or their parent?`
        : `Hi, this is Annie, from Test Prep Pundits. Am I speaking with ${studentFirst}?`;
    }
